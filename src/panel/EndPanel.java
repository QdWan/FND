...
public class EndPanel extends BasePanel implements Runnable
{
...
//    private Graphics2D gBuffer = null;
    ...
    public EndPanel(SceneManager parent)
    {
        setBounds(0,0,Util.width,Util.height);
        this.parent = parent;
        config_welcomeplaylist = ConfigManager.getConfig().get("endplaylist").getAsJsonArray();

        Init();
        MusicManager.loadBGM(Res.getBGM("sailiyazhige.wav"));
